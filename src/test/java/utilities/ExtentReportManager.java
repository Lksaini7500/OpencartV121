...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter = new ExtentSparkReporter(".\\reports\\" + repName); // specify location of the extent report
	...
	public void onTestSuccess(ITestResult result) {
		test = extent.createTest(result.getTestClass().getName()); // create a name entry in the report
